...
\singlespacing
\include{manIntro}
\include{manMotivation}
\include{manIssueTracking}
\include{manUserInterviews}
\include{manUseCases}
\include{manConstraintsJustification}
\include{manSolutionOverview}
\include{manJoinProcess}
\include{manProtocol}
\include{manApiProxy}
\include{manRoomStates}
\include{manElicitationValidation}
\include{manReflection}
